            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[rgba(255,255,255,0.15)] border border-white/20 rounded-xl py-3 pl-10 pr-10 placeholder:text-white/60 focus:outline-none focus:bg-[rgba(255,255,255,0.2)] focus:border-[#FFD700] transition-colors"
                  style={{ 
                    fontSize: '16px',
                    WebkitAppearance: 'none',
                    caretColor: 'white',
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={legacyLoading}
                  className="w-full bg-[rgba(255,255,255,0.15)] border border-white/20 rounded-xl py-3 pl-10 pr-4 placeholder:text-white/60 focus:outline-none focus:bg-[rgba(255,255,255,0.2)] focus:border-[#FFD700] transition-colors"
                  style={{ 
                    fontSize: '16px',
                    WebkitAppearance: 'none',
                    caretColor: 'white',
