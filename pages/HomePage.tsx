      ...
      <div className="px-4 pt-28 space-y-2 pb-52">
        ...
        <div className="w-full overflow-x-auto no-scrollbar pb-6 pt-2 -mt-2">
           <div className="flex space-x-4 px-1 min-w-min">
              ...
              >
                   {/* Ring */}
                   <div className={`p-[3px] rounded-full bg-gradient-to-tr from-[#FFD700] via-[#fff] to-[#FFD700] shadow-[0_0_15px_rgba(255,215,0,0.6)] relative transition-transform group-active:scale-95 ${
                     !hasEngagedDailyKey 
              ...
              >
                   {/* Ring */}
                   <div className={`p-[3px] rounded-full bg-gradient-to-tr from-[#3949ab] via-[#5c6bc0] to-[#3949ab] shadow-[0_0_15px_rgba(57,73,171,0.6)] relative transition-transform group-active:scale-95 ${
                     !hasEngagedMemory 
                       ? 'animate-[spin_4s_linear_infinite]' 
                       : 'animate-pulse'
                   }`}>
                      {/* Avatar Container - Counter-rotates to keep icon static */}
                      <div className={`w-[70px] h-[70px] md:w-[100px] md:h-[100px] rounded-full border-[3px] border-[#1a237e] overflow-hidden bg-[#1a237e] flex items-center justify-center relative ${
                        !hasEngagedMemory 
                          ? 'animate-[spin_4s_linear_infinite_reverse]' 
                          : ''
                      }`}>
              ...
              >
                   {/* Ring */}
                   <div className={`p-[3px] rounded-full bg-gradient-to-tr from-[#FF6B35] via-[#F7931E] to-[#FF6B35] shadow-[0_0_15px_rgba(255,107,53,0.6)] relative transition-transform group-active:scale-95 ${
                     !hasEngagedStrength 
                       ? 'animate-[spin_4s_linear_infinite]' 
                       : 'animate-pulse'
                   }`}>
                      {/* Avatar Container - Counter-rotates to keep icon static */}
                      <div className={`w-[70px] h-[70px] md:w-[100px] md:h-[100px] rounded-full border-[3px] border-[#E64A19] overflow-hidden bg-[#E64A19] flex items-center justify-center relative ${
                        !hasEngagedStrength 
                          ? 'animate-[spin_4s_linear_infinite_reverse]' 
                          : ''
                      }`}>
              ...
              >
                   {/* Ring */}
                   <div className={`p-[3px] rounded-full bg-gradient-to-tr from-[#AB47BC] via-[#BA68C8] to-[#AB47BC] shadow-[0_0_15px_rgba(171,71,188,0.6)] relative transition-transform group-active:scale-95 ${
                     !hasEngagedPrayer 
                       ? 'animate-[spin_4s_linear_infinite]' 
                       : 'animate-pulse'
                   }`}>
                      {/* Avatar Container - Counter-rotates to keep icon static */}
                      <div className={`w-[70px] h-[70px] md:w-[100px] md:h-[100px] rounded-full border-[3px] border-[#7B1FA2] overflow-hidden bg-[#7B1FA2] flex items-center justify-center relative ${
                        !hasEngagedPrayer 
                          ? 'animate-[spin_4s_linear_infinite_reverse]' 
                          : ''
                      }`}>
